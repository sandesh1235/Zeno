...
export type SavedState = { profile: Profile; routines: Routine[]; completed: number; volume: number; records: Record<string, number> };
export const defaultState: SavedState = { profile: { name: '', unit: 'kg', onboardingDone: false, reminder: false }, routines: [], completed: 0, volume: 0, records: {} };
